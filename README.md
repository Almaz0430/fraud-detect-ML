...
Система детекции мошенничества с использованием машинного обучения, REST API и расширенными AI-функциями для онлайн-проверки транзакций.
...
- **🧠 Расширенные AI-объяснения** с многоязычной поддержкой (русский, английский, казахский)
- **🤖 Conversational AI чат-бот** для консультаций по мошенничеству
- **🔍 Поиск похожих случаев** и анализ аномальных паттернов
- **💡 Система рекомендаций** по снижению рисков
- **📝 Обратная связь** для улучшения модели
- **🌐 React фронтенд** с современным UI/UX
